...
Blog Post Draft — Part 1

Title: The Excitement of a New Switch: Learning Old Commands and New Tricks
...
(📸 suggested photo: unboxing the switch, serial cable coiled neatly beside it)
...
Naturally, I wanted to try them all. Web was easy enough — I gave my laptop a manual IP on 192.168.0.2/24, pinged the switch, and voilà, the panel appeared in my browser. (📸 screenshot: first login to web panel)
...
(📸 screenshot: telnet login banner from SG3428)
...
(📸 screenshot: error messages from mistyped commands)
...
(📸 screenshot: output of show vlan with only VLAN 1)
...
Lessons learned so far 1. Immutable distros bite — toolbox saved me, but added friction. 2. Not all CLIs are Cisco — you can’t just muscle memory your way through. 3. Backspace is weird — in telnet, it requires arrow left then delete. 4. VLAN 1 is default — secure management requires more than defaults.
...
(📸 suggested: glamour shot of the serial cable plugged into server + switch)
